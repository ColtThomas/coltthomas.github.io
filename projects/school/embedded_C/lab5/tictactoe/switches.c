...
int switches_init() {
	 Xil_Out32(XPAR_GPIO_SLIDE_SWITCHES_BASEADDR + SWITCHES_OFFSET, SWITCHES_TRISTATE_SET);	//uses a function from xil_io.h to allow switches to be used
...
int32_t switches_read() {
	...
	return Xil_In32(XPAR_GPIO_SLIDE_SWITCHES_BASEADDR) & SWITCHES_ISOLATE_BITS;
}
...
void switches_runTest(){
	...
	leds_write(SWITCHES_LEDS_OFF);	// Puts out the LEDs after the test
